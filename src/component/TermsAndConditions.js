...
import "./AllCostomCss.css"; // Custom CSS import
 //*** all data set in a consept could add prpoer links****/
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to inotebook.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            <a
              href="#" //also use react router dom
            >
        ...
        <li>
          <p>
            <strong>Website</strong> refers to inotebook, accessible from{" "}
            <a
              href="http://inotebook.com"
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            <a
              href="https://www.inotebook.com/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.inotebook.com/contact
            </a>
          </p>
        </li>
        <li>
